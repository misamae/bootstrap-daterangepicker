...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var moment = (typeof window != 'undefined' && typeof window.moment != 'undefined') ? window.moment : require('moment-jalaali');
    ...
    PerisanDateRangePicker.prototype = {
        ...
        updateMonthsInView: function() {
            ...
            if (this.endDate) {
                ...
                if (!this.singleDatePicker && this.leftCalendar.month && this.rightCalendar.month &&
                    (this.startDate.format('jYYYY-jMM') == this.leftCalendar.month.format('jYYYY-jMM') || this.startDate.format('jYYYY-jMM') == this.rightCalendar.month.format('jYYYY-jMM'))
                    &&
        ...
        renderCalendar: function(side) {
            ...
            var selectedDateString = '' + jYear + '-' + (jMonth+1) + '-1' + ' ' + (hour) + ':' + (minute) + ':' + (second);
            ...
            var jCurDateString = '' + jLastYear + '-' + (jLastMonth+1) + '-' + (jStartDay) + ' ' + (hour) + ':' + (minute) + ':' + (second);
            ...
            for (var jRow = 0; jRow < 6; jRow++) {
                html += '<tr>';

                // add week number
                if (this.showWeekNumbers)
                    html += '<td class="week">' + calendar[jRow][0].week() + '</td>';
                else if (this.showISOWeekNumbers)
                    html += '<td class="week">' + calendar[jRow][0].isoWeek() + '</td>';

                for (var jCol = 0; jCol < 7; jCol++) {
                    ...
                    //highlight weekends
                    if (calendar[jRow][jCol].isoWeekday() > 5)
                    ...
                    if (this.minDate && calendar[jRow][jCol].isBefore(this.minDate, 'day'))
                    ...
                    if (calendar[jRow][jCol].format('jYYYY-jMM-jDD') == this.startDate.format('jYYYY-jMM-jDD'))
                        classes.push('active', 'start-date');

                    //highlight the currently selected end date
                    if (this.endDate != null && calendar[jRow][jCol].format('jYYYY-jMM-jDD') == this.endDate.format('jYYYY-jMM-jDD'))
                        classes.push('active', 'end-date');

                    //highlight dates in-between the selected dates
                    if (this.endDate != null && calendar[jRow][jCol] > this.startDate && calendar[jRow][jCol] < this.endDate)
                    ...
                    // html += '<td class="' + cname.replace(/^\s+|\s+$/g, '') + '" data-title="' + 'r' + jRow + 'c' + jCol + '">' + calendar[jRow][jCol].date() + '</td>';
                    html += '<td class="' + cname.replace(/^\s+|\s+$/g, '') + '" data-title="' + 'r' + jRow + 'c' + jCol + '">' + calendar[jRow][jCol].jDate() + '</td>';
        ...
        timeChanged: function(e) {
            ...
            if (isLeft) {
                ...
                if (this.singleDatePicker) {
                    this.endDate = this.startDate.clone();
                } else if (this.endDate && this.endDate.format('jYYYY-jMM-jDD') == start.format('jYYYY-jMM-jDD') && this.endDate.isBefore(start)) {
